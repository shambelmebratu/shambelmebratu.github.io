...
import { Menu, X, Mail, Github, Linkedin, Phone, MapPin, Calendar, ExternalLink, Award, GraduationCap, Briefcase, Code2, Sun, Moon } from "lucide-react";
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 font-inter transition-colors duration-300">
      {/* Navigation */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-semibold text-gray-900 dark:text-white">Shambel Mebratu</span>
            </div>
            ...
            <div className="px-4 py-4 space-y-2">
              {["about", "experience", "skills", "education", "contact"].map((section) => (
                <button
                  key={section}
                  onClick={() => scrollToSection(section)}
                  className="block w-full text-left px-3 py-2 rounded-lg capitalize font-medium text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-gray-50 dark:hover:bg-gray-700"
                >
                  {section === "education" ? "Education" : section}
                </button>
              ))}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            {experiences.map((exp, index) => (
              <div
                key={index}
                className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-700 dark:to-gray-600 rounded-xl p-6 border border-blue-100 dark:border-gray-600 hover:shadow-lg transition-shadow animate-slide-in-left"
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                  ...
                  <div className="mt-2 sm:mt-0 text-right">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-xs">{exp.type}</p>
                  </div>
                </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {skills.map((skill, index) => (
              <div
                key={index}
                className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow border border-gray-100 dark:border-gray-700 animate-fade-in"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
      ...
      <section id="education" className="py-16 px-4 sm:px-6 lg:px-8 bg-white dark:bg-gray-800">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-4">
              Education & Certifications
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Education */}
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900 dark:to-emerald-900 p-6 rounded-xl border border-green-100 dark:border-green-800">
              <div className="flex items-center mb-4">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm">Adama, Ethiopia</p>
                  <p className="text-gray-500 dark:text-gray-400 text-xs flex items-center mt-1">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 text-sm mt-2"
                  >
            ...
            {/* Certifications */}
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900 dark:to-indigo-900 p-6 rounded-xl border border-blue-100 dark:border-blue-800">
              <div className="flex items-center mb-4">
              ...
              <div className="space-y-4">
                {certifications.map((cert, index) => (
                  <div key={index} className="border-l-4 border-blue-600 dark:border-blue-400 pl-4 py-2">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 text-xs mt-1"
                    >
                      <ExternalLink className="w-3 h-3 mr-1" />
                      View Credential
                    </a>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-blue-600 dark:text-blue-400 text-sm">shambelmebratu@gmail.com</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-blue-600 dark:text-blue-400 text-sm">Connect with me</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-blue-600 dark:text-blue-400 text-sm">View my projects</p>
                </div>
              </a>
              ...
              <div className="flex items-center p-4 bg-blue-50 dark:bg-blue-900 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-sm">Ethiopia</p>
                </div>
              </div>
            </div>
          </div>
